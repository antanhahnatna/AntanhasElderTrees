...
public class AntanhasElderTrees extends LoopingScript {
    ...
    private long handleBanking() {
        ...
        */
        ...
        //Execution.delayUntil(random.nextLong(1500, 3000), () -> Bank.depositAllExcept("Mechanised siphon", "Elder wood box", "Eternal magic wood box", "Decorated woodcutting urn (r)", "Decorated woodcutting urn", "Decorated woodcutting urn (full)", "Juju woodcutting flask (6)", "Juju woodcutting flask (5)", "Juju woodcutting flask (4)", "Juju woodcutting flask (3)", "Juju woodcutting flask (2)", "Juju woodcutting flask (1)", "Juju woodcutting potion (4)", "Juju woodcutting potion (3)", "Juju woodcutting potion (2)", "Juju woodcutting potion (1)", "Perfect juju woodcutting flask (6)", "Perfect juju woodcutting flask (5)", "Perfect juju woodcutting flask (4)", "Perfect juju woodcutting flask (3)", "Perfect juju woodcutting flask (2)", "Perfect juju woodcutting flask (1)", "Perfect juju woodcutting potion (4)", "Perfect juju woodcutting potion (3)", "Perfect juju woodcutting potion (2)", "Perfect juju woodcutting potion (1)"));
        Execution.delayUntil(random.nextLong(1500, 3000), () -> Bank.depositAllExcept(41092, 54913, 58253, 39012, 39014, 39015, 23149, 23150, 23151, 23152, 23153, 23154, 20015, 20016, 20017, 20018, 32859, 32857, 32855, 32853, 32851, 32849, 32759, 32757, 32755, 32753));
        //Execution.delay(random.nextLong(1000,2000));
        if(
                hasNormalJujuPotion
                        && !(
